...
class RecordForm(forms.Form):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields['tarif'] = forms.DecimalField(label="Tarif", required=True, ) # amélioration possible: valeur par défault dépendant des consultations passées

class GetByPatients(RecordForm): 
    def __init__(self, *args, **kwargs):
        super(GetByPatients, self).__init__(*args, **kwargs)
        self.fields.pop('payed')
        self.fields.pop('tarif')
